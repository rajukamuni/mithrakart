...
<html>
  ...
  <body>
    ...
    <div class="row alert alert-success" role="alert">
      <?php 
        $added_to_cart = $_SESSION['added_to_cart'];
        $msg = $_SESSION['msg'];
      if(!empty($added_to_cart)) { 

      ?>
        <div class="col-12">
          <h5><i class="fa fa-check" aria-hidden="true"></i>  Added to cart successfully..</h5>
          <p><?php echo $msg; ?></p>
        </div>
        <div class="col-12">
          <a href="cart.php"><button class="btn btn-info">Checkout</button></a>
        </div>
      ...
      ?>
        <div class="col">
          <h5><i class="fa fa-times" aria-hidden="true"></i>  Can't add this item to cart.. Try Again...!</h5>
          <p><?php echo $msg; ?></p>
        </div>
