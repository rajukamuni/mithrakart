...
<?php 
  ...
  $query = "INSERT INTO orders (item_id, item_name, customer, customer_id, quantity, amount) VALUES
        ('" . $item_id . "', '" . $item_name . "', '" . $customer_name . "', '" . $customer_id . "', '" . $quantity . "', '" . $total_price . "')";
  $result = $db_handle->insertQuery($query);
  if(!empty($result)) {
    $message = "Order Placed successfully!"; 
    unset($_POST);
  } else {
    $message = "Problem in Order Placing. Try Again!"; 
  }
?>
<!DOCTYPE html>
<html>
