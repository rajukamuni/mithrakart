    ...
    <div class="main-wrapper col-12">
      ...
      <ul class="list-unstyled row cart-view-row">
        ...
        <li class="col-6 col-md-3">
          <h4><span>Quantity: </span> <?php echo $quantity; ?></h4>
        </li>
        <li class="col-6 col-md-2">
      ...
      ?>
        <ul class="list-unstyled address-view-row">
          <li class="row"><span class="col-6 col-md-2">Name </span><span class="col-6 col-md-10">: <?php echo $full_name; ?></span></li>
          <li class="row"><span class="col-6 col-md-2">Mobile Number </span><span class="col-6 col-md-10">: <?php echo $delivery_mobile; ?></span></li>
          <li class="row"><span class="col-6 col-md-2">Pin code </span><span class="col-6 col-md-10">: <?php echo $pincode; ?></span></li>
          <li class="row"><span class="col-6 col-md-2">House Number </span><span class="col-6 col-md-10">: <?php echo $house_no; ?></span></li>
          <li class="row"><span class="col-6 col-md-2">Colony </span><span class="col-6 col-md-10">: <?php echo $colony; ?></span></li>
          <li class="row"><span class="col-6 col-md-2">Landmark </span><span class="col-6 col-md-10">: <?php echo $landmark; ?></span></li>
          <li class="row"><span class="col-6 col-md-2">City </span><span class="col-6 col-md-10">: <?php echo $city; ?></span></li>
        </ul>
        <?php 
          }
        }else{ 
     ...
     <?php }session_write_close(); ?>
            <div class="row alert alert-success" role="alert">
              ...
              <div class="col-12 col-md-4">
                <a href="payment_cart.php"><button class="btn btn-info">Proceed to Checkout</button></a>
              </div>
            </div>
