  ...
  <body>
    ...
    <div class="main-row main-wrapper">
      <div class="row">
        ...
        <div class="col-6 col-md-4">
          <form action="log_in.php" method="post" role="form" enctype="multipart/form-data" class="" id="addToCartForm">
            ...
            <input type="submit" class="btn btn-info" name="submit" value="Buy now">
          </form>
        </div>
        </div>
          <div class="row">
